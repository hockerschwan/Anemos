...
{
    private const uint WAINACTIVE = 0x00;
    private const uint WAACTIVE = 0x01;
    ...
    public static partial IntPtr SendMessage(IntPtr hWnd, uint Msg, uint wParam, uint lParam);
    ...
    public static void UpdateTitleBar(ElementTheme theme)
    {
        if (App.MainWindow.ExtendsContentIntoTitleBar)
        {
            ...
            {
                SendMessage(hwnd, WMACTIVATE, WAINACTIVE, 0);
