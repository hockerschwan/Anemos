...
typedef void (*callback_function_void)();
...
extern "C" DLL void SetCallback_Close(callback_function_void callback);
...
static callback_function_void g_callback_close_ = NULL;
